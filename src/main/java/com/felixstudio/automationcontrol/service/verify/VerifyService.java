...
public class VerifyService {
    ...
    public VerifyService(BusinessSmSInfoService businessSmSInfoService, SmsShortCodeService smsShortCodeService) {
        this.businessSmSInfoService = businessSmSInfoService;
        this.smsShortCodeService = smsShortCodeService;
    }

    // 发起短信验证码请求
    public String sendSmSCode(String flowName, String verifyPhone, String chanelId) {
